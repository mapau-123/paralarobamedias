...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (audio && btnPlay) {
    ...
    // Algunos navegadores (sobre todo en móvil) estiman mal la duración
    // al principio y la corrigen después de descargar más del archivo.
    // Escuchamos también este evento para que el tiempo mostrado se
    // actualice si eso pasa, en vez de quedarse con el número inicial
    // incorrecto.
